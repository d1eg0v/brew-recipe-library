// Regression test for the ThemeSwitcher hydration mismatch (BRE-21).
//
// The button label rendered on the server must match the first client render,
// otherwise React aborts hydration. We render the component twice — once in a
// "no document" pass (the SSR path) and once with a faked `data-theme`
// differing from DEFAULT_THEME (the hydration path) — and assert the rendered
// label text is identical in both. Together with the post-mount effect in the
// component itself, this pins both ends of the contract.
...
describe("ThemeSwitcher hydration (BRE-21)", () => {
